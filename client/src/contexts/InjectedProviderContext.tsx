...
const defaultInjectedProviderContext = {
  isConnected: false,
  signer: undefined,
  provider: undefined,
  connectWallet: () => {},
...
const InjectedProviderContext = createContext<{
  isConnected: boolean;
  ...
  address: string
  balance: number;
}>(defaultInjectedProviderContext);

interface WalletProviderProps {
  children: React.ReactNode;
}

export const InjectedProvider = (props: WalletProviderProps) => {
  const wallet = useWallet();
  return (
    <InjectedProviderContext.Provider value={wallet}>
      {props.children}
